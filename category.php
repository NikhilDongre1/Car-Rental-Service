...
<body>
    ...
    <div class="vehicles">
        ...
        // Fetch all vehicles
        $sql = "SELECT id, make, model, year, price,availability, image FROM vehicles WHERE availability >= 1";
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo '<p>Price: Rs ' . $row["price"] . '/day</p>';
                echo "<p>Available units: " . $row['availability'] . "</p>";
